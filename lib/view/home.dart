        ...
        child: Container(
          ...
          child: Column(
            children: [
              ...
              // 🔄 FutureBuilder untuk menampilkan daftar game
              FutureBuilder<List<Game>>(
                future: fetchGames(), // Mengambil data game dari viewmodel
                          ...
                          return GestureDetector(
                            onTap: () {
                              Navigator.pushNamed(
                                context,
                                '/detail',
                                arguments: game.id, // Kirim ID game ke halaman detail
                              );
                            },
                            child: _listItem(
                              game.thumbnail,
...
/// 🕹️ Fungsi untuk membuat tampilan tiap item game
